...
if( DO_NOT_CHANGE_OUTPUT_PATHS_ON_FIRST_PASS )
 ...
 set( LIBRARY_OUTPUT_PATH "${LIBRARY_OUTPUT_PATH_ROOT}/build/${ARMEABI_NDK_NAME}/lib" CACHE PATH "path for android libs" FORCE)
...
if( NOT FORCE_ARM )
 ...
 set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -marm -ffast-math -mno-thumb -mno-thumb-interwork -ffunction-sections" )
 set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -marm -ffast-math -mno-thumb -mno-thumb-interwork -ffunction-sections" )
endif()
...
#set( LINKER_FLAGS "-Wl,-soname,/data/data/com.whitestar.mytunes/lib/libtag.so ${LINKER_FLAGS}" )
